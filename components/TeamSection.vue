            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up" data-aos-delay="100">
                    <div class="section-title process text-center pb-90">
                        ...
                        <h3 class="title">Apa kata Alumnus Kampus Indonesia?</h3>
                ...
                teamMembers: [
                    {
                        ...
                        name: "Budi Doremi",
                        designation: "Alumnus Internship Kampus Indonesia Batch 1",
                        socialLink: [
                            {
                    ...
                    },
                    {
                        ...
                        name: "Rosie Greene",
                       designation: "Alumnus Internship Kampus Indonesia Batch 2",
                        socialLink: [
                            {
                                icon: "icofont-facebook",
                                url: "#"
                    ...
                    },
                    {
                        ...
                        name: "Stacey Evans",
                        designation: "Alumnus Internship Kampus Indonesia Batch 3",
                        socialLink: [
                            {
                                icon: "icofont-facebook",
                                url: "#"
                    ...
                    },
                    {
                        ...
                        name: "Marian Adams",
                        designation: "Alumnus Internship Kampus Indonesia Batch 4",
                        socialLink: [
                            {
                                icon: "icofont-facebook",
                                url: "#"
